...
CREATE TABLE `attendance` (
  ...
  `attendance_status` tinyint(1) unsigned DEFAULT '1',
  `attendance_detail` varchar(450) DEFAULT NULL,
  `attendance_date_out_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `student` (`student_id`,`student_full_name`,`student_name_with_initials`,`student_nic`,`student_dob`,`student_gender`,`student_address`,`student_contact_mobile`,`student_contact_email`,`student_contact_home`,`student_remark_1`,`student_remark_2`,`student_status`) VALUES 
 (1,'test user','t. user','654987321v','2020-08-09','Male','test address','0777123456','test@gmail.com','','stu-000001','',1),
 (2,'full name 2','f name 2','910550292v','2020-08-27','Male','test address 2','0777712345','test2@gmail.com','0117100100','stu-000002','',1);
