...
public class manageStudents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tblStudentDetails.getColumnModel().getColumnCount() > 0) {
            ...
            tblStudentDetails.getColumnModel().getColumn(2).setMinWidth(250);
            tblStudentDetails.getColumnModel().getColumn(2).setPreferredWidth(250);
            tblStudentDetails.getColumnModel().getColumn(2).setMaxWidth(250);
            ...
            tblStudentDetails.getColumnModel().getColumn(7).setMinWidth(225);
            tblStudentDetails.getColumnModel().getColumn(7).setPreferredWidth(225);
            tblStudentDetails.getColumnModel().getColumn(7).setMaxWidth(225);
            tblStudentDetails.getColumnModel().getColumn(8).setMinWidth(150);
            tblStudentDetails.getColumnModel().getColumn(8).setPreferredWidth(150);
            tblStudentDetails.getColumnModel().getColumn(8).setMaxWidth(150);
